...
$config['db_host'] = '192.168.1.80';
$config['db_name'] = 'von_wiesen_db';
$config['db_user'] = 'mastervw_mysql';
$config['db_password'] = 'Esmart~!2';
...
//$config['http_host'] = '192.168.1.80';
//$config['http_host'] = 'von-wiesen.com';
//$config['http_path'] = '';

// Host and directory where software is installed on secure server
//$config['https_host'] = '192.168.1.80';
//$config['https_host'] = 'von-wiesen.com';
//$config['https_path'] = '';
...
$config['admin_index']    = 'vw_admin.php';
...
// Set to unique store prefix if you use the same Redis/Xcache/Apc storage
// for serveral cart installations
$config['store_prefix'] = 'Q3VfScUC86K'; // random key
//*/
