...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($mode == 'login') {
        ...
        //
            ...
            if (AREA === 'C' && defined('AJAX_REQUEST') && isset($_REQUEST['error_container_id'])) {
                ...
                $view->assign([
                    'login_error'        => true,
                    'error_container_id' => $_REQUEST['error_container_id']
                ]);

                if ($view->templateExists('views/auth/components/login_errors.tpl')) {
                    $ajax->assignHtml($_REQUEST['error_container_id'], $view->fetch('views/auth/components/login_errors.tpl'));
                    $view->clearAssign(['login_error', 'error_container_id']);
