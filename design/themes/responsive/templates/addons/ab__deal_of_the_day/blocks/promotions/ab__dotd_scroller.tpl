...
{if $items}
    ...
    <div class="all-promotions__button"{if $block.properties.outside_navigation != "Y"} style="right: 0;"{/if}><a href="{"promotions.list"|fn_url}" title="">{__("ab__dotd.all_promotions_list")}</a></div>
