...
<div id="box_attach_images_{$name}_{$key}" class="attach-images">
    ...
    <div
        class="
            upload-box
            {if $no_thumbnail && !$pair.icon} hidden {/if}
            sd-user-profile-upload-image-box
        "
        ...
        <div class="pull-left image-wrap">
            {if $pair.image_id}
                {if !("MULTIVENDOR"|fn_allowed_for
                    ...
                    <a
                        data-ca-target-id="image_{$pair.image_id}"
                        ...
                        class="
                            ...
                            cm-ajax
                            delete
                            cm-delete-image-link
                            cm-tooltip
                            ty-btn
                        "
                        data-ca-event="ce.delete_image"
                        title="{__("remove")}"
                    >
                        {__("remove")}
                    </a>
