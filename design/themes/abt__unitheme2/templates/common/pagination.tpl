...
{if $pagination.total_pages > 1}
    ...
    {/if}
    <div class="ty-pagination" id="pagination_block{if $smarty.capture.pagination_open == "Y"}_bottom{/if}">
        ...
        {/if}
    <!--pagination_block{if $smarty.capture.pagination_open == "Y"}_bottom{/if}--></div>
    {if $smarty.capture.pagination_open == "Y"}
        </div>
    {/if}
    {else}
