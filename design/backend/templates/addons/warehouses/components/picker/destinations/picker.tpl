...
<div class="object-picker__simple object-picker__simple--destinations">
    ...
    <a class="btn cm-ajax" data-ca-target-id="show_to" href="{"store_locator.update?store_location_id={$store_location.store_location_id}&selected_section=pickup&add_all_destinations"|fn_url}">
