...
<div class="table-responsive-wrapper">
    ...
    *}
        <td class="center row-status" data-th="{__("code")}">
        ...
        <td class="center row-status" data-th="{__("code")}&nbsp;A3">
        ...
        <td class="center row-status" data-th="{__("code")}&nbsp;N3">
        ...
        <td class="center row-status" data-th="{__("region")}">
